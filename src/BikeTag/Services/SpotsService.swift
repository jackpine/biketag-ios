...
class SpotsService: ApiService {
    ...
    func fetchCurrentSpots(location: CLLocation, successCallback: @escaping ([ParsedSpot])->(), errorCallback:  @escaping (Error)->()) {
    ...
    func postNewSpot(spot: Spot, callback: @escaping (ParsedSpot)->(), errorCallback: @escaping (Error)->()) {
        // TODO use param struct
    ...
    func postSpotGuess(guess: Guess, callback: @escaping (Guess)->(), errorCallback: @escaping (Error)->()) {
        // TODO use param struct
