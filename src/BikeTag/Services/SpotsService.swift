...
class SpotsService: ApiService {
    func fetchCurrentSpots(location: CLLocation, successCallback: @escaping ([ParsedSpot]) -> Void, errorCallback: @escaping (Error) -> Void) {
        ...
        request(.get, path: "games/current_spots.json", parameters: parameters, handleResponseAttributes: handleResponseAttributes, errorCallback: errorCallback)
    }
    ...
    func postNewSpot(spot: Spot, callback: @escaping (ParsedSpot) -> Void, errorCallback: @escaping (Error) -> Void) {
        ...
        request(.post, path: "spots.json", parameters: parameters, handleResponseAttributes: handleResponseAttributes, errorCallback: errorCallback)
    }
    ...
    func postSpotGuess(guess: Guess, callback: @escaping (Guess) -> Void, errorCallback: @escaping (Error) -> Void) {
        ...
        request(.post, path: "guesses.json", parameters: parameters, handleResponseAttributes: handleResponseAttributes, errorCallback: errorCallback)
    }
