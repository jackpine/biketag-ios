...
class FakeSpotsService: SpotsService {
    ...
    override func fetchCurrentSpots(location: CLLocation, successCallback: @escaping ([ParsedSpot]) -> Void, errorCallback: @escaping  (Error) -> Void) {
    ...
    override func postNewSpot(spot: Spot, callback: @escaping (ParsedSpot) -> Void, errorCallback: @escaping (Error) -> Void) {
    ...
    override func postSpotGuess(guess: Guess, callback: @escaping (Guess) -> Void, errorCallback: @escaping (Error) -> Void) {
