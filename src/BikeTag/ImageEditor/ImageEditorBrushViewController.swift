...
public class ImageEditorBrushViewController: BaseViewController {
  ...
  override public func loadView() {
    ...
    let brushGestureRecognizer = ImageEditorPanGestureRecognizer(
      target: self, action: #selector(handleBrushGesture(_:)))
  ...
  public func handleBrushGesture(_ gestureRecognizer: ImageEditorPanGestureRecognizer) {
    ...
    let unitStrokeWidth =
      ImageEditorStrokeItem.defaultUnitStrokeWidth() / model.currentTransform().scaling
    ...
    case .began:
      ...
      let stroke = ImageEditorStrokeItem(
        color: strokeColor, unitSamples: currentStrokeSamples, unitStrokeWidth: unitStrokeWidth)
    ...
    case .changed, .ended:
      ...
      let stroke = ImageEditorStrokeItem(
        itemId: lastStroke.itemId, color: strokeColor, unitSamples: currentStrokeSamples,
