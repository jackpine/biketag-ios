...
public class ImageEditorCanvasView: UIView {
    ...
    private class func strokeLayerForItem(item: ImageEditorStrokeItem,
        ...
        for index in 0 ..< points.count {
            ...
            if points.count <= 1 {
                ...
                forwardVector = CGPoint.add(previousPointForwardVector, nextPointForwardVector).scaled(by: 0.5)
            }
            ...
            if index == 0 {
                ...
                let controlPoint1 = CGPoint.add(previousPoint, previousForwardVector.scaled(by: +controlPointFactor))
    ...
    private class func textLayerForItem(item: ImageEditorTextItem,
        ...
        let layerSize = CGSize(width: textBounds.size.width.rounded(.up), height: textBounds.size.height.rounded(.up))
    ...
    private class func applySmoothing(to points: [CGPoint]) -> [CGPoint] {
        ...
        for index in 0 ..< points.count {
            ...
            if index == 0 {
                ...
                let smoothedPoint = CGPoint.add(point.scaled(by: 1.0 - 2.0 * alpha),
                                                CGPoint.add(lastPoint.scaled(by: alpha),
