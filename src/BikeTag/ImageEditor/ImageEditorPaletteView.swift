...
private class PalettePreviewView: ImageEditorLayerView {
    ...
    static func updateLayers(view: UIView,
        ...
        let circleFrame = CGRect(origin: circleCenter.minus(asPoint.scaled(by: 0.5)),
...
public class ImageEditorPaletteView: UIView {
    ...
    private func value(for palettePhase: CGFloat) -> ImageEditorColor {
        ...
        let segmentPhase = palettePhase.inverseLerp(segment.palettePhase0, segment.palettePhase1).clamped(by: 0 ... 1)
